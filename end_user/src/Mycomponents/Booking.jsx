...
function Booking() {
  ...
  const sendBookingInfo = async () => {
    ...
    try {
      const response = await axios.post("https://dtc-bus-online-hkcf.vercel.app/api/send-booking-info", {
  ...
  const handleSubmit = async (e) => {
    ...
    if (bookingData.from === bookingData.to) {
      ...
      try {
        ...
        const response = await axios.post("https://dtc-bus-online-hkcf.vercel.app/api/booking", {
          ...bookingData,
          id: newticketId,
        });
